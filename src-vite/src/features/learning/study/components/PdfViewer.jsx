  ...
  if (!pdfSource) {
    return (
      <div className={`flex flex-col items-center justify-center p-8 bg-gray-50 rounded-lg ${className}`}>
        ...
        <h3 className="text-lg font-medium text-gray-700 mb-2">PDF 파일 정보</h3>
        ...
        <p className="text-xs text-amber-600 bg-amber-50 px-4 py-2 rounded">
  ...
  if (error) {
    return (
      <div className={`flex flex-col items-center justify-center p-8 bg-gray-50 rounded-lg ${className}`}>
        ...
        <h3 className="text-lg font-medium text-gray-700 mb-2">PDF 로드 실패</h3>
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-white border-b">
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="font-medium text-gray-800 truncate text-sm">{title || 'PDF 문서'}</h3>
          </div>
        </div>
